...
values
  (
    ...
    'maximus-01',
    '(93) 98405-7229',
    'Av. Altamira, 188 - Santíssimo - Santarém-PA',
    -2.4314308,
    -54.7090428,
    true,
    '[]'::jsonb,
  ...
  (
    ...
    'maximus-02',
    '(93) 98419-3005',
    'Av. Sérgio Henn, 1 - Floresta - Santarém-PA',
    -2.4544953,
    -54.7148729,
    true,
    '[]'::jsonb,
...
with settings_seed(
  ...
  values
    ...
    (
      ...
      false,
      '(93) 98419-3005',
      '{"enabled":false,"provider":"none","officialNumber":"(93) 98419-3005","receivedMessage":"Recebemos seu pedido na Maximus. Em breve nossa equipe vai confirmar.","acceptedMessage":"Seu pedido foi aceito e ja entrou no fluxo da Maximus.","productionMessage":"Seu pedido esta em producao.","readyMessage":"Seu pedido esta pronto.","outForDeliveryMessage":"Seu pedido saiu para entrega.","driverOnWayMessage":"Seu entregador esta a caminho.","driverNearbyMessage":"Seu entregador esta a 500 metros.","deliveredMessage":"Pedido entregue. Obrigado por comprar com a Maximus."}'::jsonb,
      false,
      false,
      false,
      '{"autoPrintEnabled":false,"printerName":"Cozinha","printerIp":"","printerPort":9100,"printerType":"escpos","copies":1}'::jsonb,
